...
plt.plot([k for k in range(len(paikro_data.ecg_filtered))], paikro_data.ecg_filtered)
plt.plot([j for j in range(len(paikro_data.ecg_deriv))], paikro_data.ecg_deriv)
plt.show()
